...
I was surprised by how differently hard links and symbolic links work. Creating a hard link with ln showed me that both files can point to the same underlying data, while ln -s creates a separate link that points to the original file's path.

## Evidence
Terminal transcript of the completed Day 5 checkpoint drill is stored in `evidence.md/`.

## Related
Previous day: [../day-04-filesystem-search/](../day-04-filesystem-search)

Next day: [../day-06-permissions/](../day-06-permissions)
